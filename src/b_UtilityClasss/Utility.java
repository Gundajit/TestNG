...
{
	public static String ReadDataFromExel(int RowNum, int ColumnNum) throws IOException
	{
		FileInputStream Myfile=new FileInputStream("I:\\Educational File\\TESTING MODULE\\Screenshot\\ExelPractice.xlsx");
		Sheet Mysheet = WorkbookFactory.create(Myfile).getSheet("Sheet4");
		String Value = Mysheet.getRow(RowNum).getCell(ColumnNum).getStringCellValue();
		return Value;
